...
const WeatherLayerControl: React.FC = () => {
  ...
  const { metric, setMetric, date, setDate } = useWeatherLayerContext();

  // Visibility and opacity are controlled from the host's unified Layers menu;
  // this panel only chooses which metric/date the raster layer renders.
  return (
